...
const InfoRow = ({ label, value }) => (
  ...
  >
    <span style={{ color: "#9ca3af", fontSize: "13px", minWidth: "160px" }}>
      {label}
    </span>
...
const TourDetailPage = () => {
  ...
  const handleCancelTour = async () => {
    if (
      !window.confirm(
        `Bạn có chắc muốn hủy tour "${tour.name}"?\nHành động này không thể hoàn tác.`,
      )
    )
      return;
    try {
    ...
    <div style={{ maxWidth: "900px", margin: "0 auto" }}>
      ...
      >
        ...
        >
          <div>
            <div
              style={{ opacity: 0.7, fontSize: "13px", marginBottom: "6px" }}
            >
              {tour.code}
            </div>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            />
            <div
              style={{ marginTop: "12px", fontSize: "22px", fontWeight: 800 }}
            >
      ...
      >
        ...
        >
          ...
          <InfoRow
            label="Số khách"
            value={`${tour.currentGuests}/${tour.maxGuests} khách`}
          />
          <InfoRow label="Ngôn ngữ yêu cầu" value={tour.requiredLanguages} />
          <InfoRow
            label="Chuyên môn yêu cầu"
            value={tour.requiredSpecialization}
          />

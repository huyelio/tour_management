  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ marginTop: "6px" }}>
            {/* <Badge
              label={getGuideStatusLabel(guide.status)}
              color={getGuideStatusColor(guide.status)}
            /> */}
          </div>
        </div>
      </div>
      ...
      >
        <div>
          Ngoại ngữ:{" "}
          <strong style={{ color: "#374151" }}>{guide.languages}</strong>
        </div>
        <div>
          Chuyên môn:{" "}
          <strong style={{ color: "#374151" }}>{guide.specialization}</strong>
        </div>
        <div>
          Khu vực: <strong style={{ color: "#374151" }}>{guide.region}</strong>
        </div>
        <div>
          Kinh nghiệm:{" "}
          <strong style={{ color: "#374151" }}>
            {guide.experienceYears} năm
          </strong>
        </div>
        {guide.phone && (
          <div>
            Điện thoại:{" "}
            <strong style={{ color: "#374151" }}>{guide.phone}</strong>
          </div>
        )}
      </div>
    </div>
